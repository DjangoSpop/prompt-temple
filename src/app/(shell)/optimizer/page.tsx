...
export default function OptimizerPage() {
  ...
  const [optimizationHistory, setOptimizationHistory] = useState<OptimizerResult[]>([]);
...
- Provide specific examples where relevant`,
        ...
        model_variants: {
          ...
          'gemini-pro': 'Variant optimized for Gemini with structured approach...',
        },
        estimated_improvement: '73%',
        optimization_type: optimizationSettings.focus,
          ...
          {optimizationResult && (
            <Card className="p-6">
              <div className="space-y-6">
                ...
                {/* Model Variants */}
                {optimizationResult.model_variants && Object.keys(optimizationResult.model_variants).length > 0 && (
                  <div className="space-y-3">
                    <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">
                      Model-Specific Variants
                    </h3>
                    <div className="space-y-3">
                      {Object.entries(optimizationResult.model_variants).map(([model, variant]) => (
