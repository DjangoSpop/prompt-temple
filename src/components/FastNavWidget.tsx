...
import { HelpAgent } from '@/components/onboarding';
...
const pages: PageItem[] = [
  ...
  { name: 'Templates', path: '/templates', icon: FileText, description: 'Template library' },
  ...
  { name: 'Learning', path: '/learning', icon: BookOpen, description: 'Learning resources' },
